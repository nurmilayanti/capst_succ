...
st.markdown("""
    <div style='text-align: justify;'>
        ...
        <h11>5. Kehadiran 3 local brand di antara top 5 brand menunjukkan bahwa brands lokal telah berhasil meningkatkan kualitas dan reputasi mereka. Hal ini mencerminkan kemajuan dalam industri lokal dan kemampuan untuk bersaing dengan produk internasional.</h11>
    </div>
""", unsafe_allow_html=True)
